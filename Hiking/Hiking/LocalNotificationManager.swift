...
//  B1ViewController
//
//  Created by Paul Yim on 23/11/2020.
//
import UIKit
import Foundation
...
struct LocalNotificationManager{
    ...
    static private func scheduleNotifications(_ durationnSecond:Int, repeats:Bool, userInfo: [AnyHashable:Any]){
        ...
        for notification in notifications{
            ...
            let trigger = UNTimeIntervalNotificationTrigger(timeInterval: TimeInterval(durationnSecond), repeats: repeats)
